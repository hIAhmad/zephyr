...
function(generate_binary_embed_inc_file_for_target target)
  ...
  set(opt_single_args "SECTION;ALIGN;READONLY;OFFSET;LENGTH;ZIP;GZIP_MTIME")
  ...
  if(NOT DEFINED BINARY_EMBED_ZIP)
    set(zip no)
  else()
    set(zip ${BINARY_EMBED_ZIP})
    if (zip STREQUAL gzip)
      set(zip_param -g)
    else()
  ...
  # Enable use of GNU-style incbin directive, iff toolchain being used supports
